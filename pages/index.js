                                    ...
                                    <div className="box-banner-left-home7"><span className="title-line line-48">Convenient, Reliable, and Efficient</span>
                                        ...
                                        <div className="row">
                                            <div className="col-lg-10">
                                                <p className="font-md color-grey-500 mb-25">We provide top-quality cleaning services tailored to your needs. Whether it's your car, home, or business, our team is ready to help with a wide range of cleaning services.</p>
                                            </div>
                                        </div>
                      ...
                      <div className="row align-items-start">
                              ...
                              <div className="card-radius-32">
                                  <div className="card-info">
                                      ...
                                      <div className="text-center">
                                          <Link href="#"><img className="mr-10" src="/assets/imgs/template/appstore.png" alt="Download on App Store" /></Link>
                                          <Link href="#"><img src="/assets/imgs/template/google-play.png" alt="Get it on Google Play" /></Link>
                                      </div>
                                  </div>
                          ...
                          <div className="col-xl-6 col-lg-6 mb-30">
                              <div className="card-radius-32 bg-4">
                                  ...
                                  <div className="card-image">
                                      <img src="/assets/imgs/page/homepage7/box2.png" alt="Automated Platform Illustration" />
                                  </div>
                              </div>
                          </div>
                                      ...
                                      <div className="col-lg-6">
                                          <div className="box-cover-pd">
                                              <div className="box-image-rd-30">
                                                  ...
                                                  <h4 className="color-brand-1 lbl-on-top">NC Booking</h4>
                                              </div>
                                          </div>
                                      </div>
                                      <div className="col-lg-6">
                        ...
                        <div className="row align-items-center">
                            <div className="col-lg-5 mb-30">
                                ...
                                <div className="mt-40 text-start">
                                    <Link className="btn btn-brand-1 hover-up" href="#">Book Now</Link>
                            ...
                            <div className="col-lg-4 mb-30">
                                <div className="card-guide bg-4">
                                    ...
                                    <div className="card-info">
                                        ...
                                        <div className="mt-10">
                                            <Link href="#" className="btn btn-default font-sm-bold pl-0">Learn more
                                                <svg className="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                                                </svg>
                                            </Link>
                        ...
                        <div className="row align-items-start">
                            <div className="col-lg-3 col-md-6 col-sm-6">
                                <div className="card-team mb-30">
                                    <div className="card-image">
                                        <img src="/assets/imgs/page/about/team1.png" alt="John Doe - CEO" />
                                    </div>
                                    <div className="card-info">
                                        <Link className="font-lg" href="#">John Doe</Link>

                        ...
                        <div className="box-business-rd">
                            <div className="row align-items-center">
                                <div className="col-lg-5">
                                    <span className="btn btn-tag">Services</span>
                                    <h3 className="color-brand-1 mt-10 mb-15">Explore Our Professional Cleaning Services</h3>
                                ...
                                <div className="col-lg-7">
                                    <div className="box-business-service">
                                        ...
                                        <div className="box-image-1 shape-3">
                                            <img src="assets/imgs/page/service/img1.png" alt="Car Cleaning" />
                                        </div>

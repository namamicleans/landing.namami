...
const Redirect = () => {
  ...
  useEffect(() => {
    ...
    if (location.pathname === "/scan") {
      window.location.href = "https://app.namamicleans.com";
      return;
    }
    ...
    if (type && REDIRECT_TYPES[type as keyof typeof REDIRECT_TYPES]) {
      const redirectConfig =
        REDIRECT_TYPES[type as keyof typeof REDIRECT_TYPES];
  ...
  const type = searchParams.get("type");
  const isValidType =
    type && REDIRECT_TYPES[type as keyof typeof REDIRECT_TYPES];
          ...
          <>
            ...
            <p className="text-sm text-gray-500">
              ...
              <span className="font-semibold">
                {REDIRECT_TYPES[type as keyof typeof REDIRECT_TYPES].text}
              </span>
            </p>
          </>
        ) : (
